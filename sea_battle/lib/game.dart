...
class Game {
  ...
  void checkWinner() {
    if (player1.isDefeated()) {
      ...
      player2.amount_wins++;
      player1.amount_losses++;
    } else if (player2.isDefeated()) {
      print('Победитель ${player1.name}');
      player1.amount_wins++;
      player2.amount_losses++;
    }
    print('----------------------------------------------------------------------------');
    print('Таблица счета игроков');
    print('Игок ${player1.name} произвел ${player1.amount_hits} успешных выстрела\n ${player1.amount_fails} промахов');
    print('Итого: ${player1.amount_wins} побед \n ${player1.amount_losses} поражений');
    print('----------------------------------------------------------------------------');
    print('Игок ${player2.name} произвел ${player2.amount_hits} успешных выстрела\n ${player2.amount_fails} промахов');
    print('Итого: ${player2.amount_wins} побед \n ${player2.amount_losses} поражений');
    print('----------------------------------------------------------------------------');
  }
